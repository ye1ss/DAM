...
var gj=[12];var hj=new Ni("continuationCommand");var ij=new Ni("webCommandMetadata");var jj=new Ni("signalServiceEndpoint");var kj={oi:"EMBEDDED_PLAYER_MODE_UNKNOWN",li:"EMBEDDED_PLAYER_MODE_DEFAULT",ni:"EMBEDDED_PLAYER_MODE_PFP",mi:"EMBEDDED_PLAYER_MODE_PFL"};var lj=new Ni("feedbackEndpoint");var mj={Mq:"WEB_DISPLAY_MODE_UNKNOWN",Iq:"WEB_DISPLAY_MODE_BROWSER",Kq:"WEB_DISPLAY_MODE_MINIMAL_UI",Lq:"WEB_DISPLAY_MODE_STANDALONE",Jq:"WEB_DISPLAY_MODE_FULLSCREEN"};function nj(a){H.call(this,a,-1,oj)}
...
u(Uj,H);function Vj(a){H.call(this,a)}
u(Vj,H);function Wj(a){H.call(this,a,449)}
u(Wj,H);
...
352,353,354,355,356,357,358,361,363,364,368,369,370,373,374,375,378,380,381,388,389,403,410,412,429,413,414,415,416,417,418,430,423,424,425,426,427,431,117,439,441,448];var Yj={qj:0,bj:1,hj:2,ij:4,nj:8,jj:16,kj:32,pj:64,oj:128,dj:256,fj:512,mj:1024,ej:2048,gj:4096,cj:8192,lj:16384};function Zj(a){H.call(this,a)}
...
function co(a,b,c){c=void 0===c?{}:c;var d={};L("EOM_VISITOR_DATA")?d={"X-Goog-EOM-Visitor-Id":L("EOM_VISITOR_DATA")}:d={"X-Goog-Visitor-Id":c.visitorData||L("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.ir||L("AUTHORIZATION"))||(a?b="Bearer "+B("gapi.auth.getToken")().hr:b=xg([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=L("SESSION_INDEX",0),M("pageid_as_header_web")&&(d["X-Goog-PageId"]=L("DELEGATED_SESSION_ID")));return d}
...
;var ip;function jp(){var a=lo.call;ip||(ip=new gp({wr:!0,qr:!0}));a.call(lo,this,{N:{Jc:Qo,Ba:Po,ac:Mo,Zc:No,Hb:Oo,set:Ko},L:ip,handleError:Rk,Ca:Sk,ia:kp,now:Q,zc:dp,Y:Wl(),Db:"publicytnetworkstatus-online",Cb:"publicytnetworkstatus-offline",gb:!0,fb:.1,lb:Lk("potential_esf_error_limit",10),J:M,Ka:!(Xl()&&lp())});this.j=new Eh;M("networkless_immediately_drop_all_requests")&&Ro();Hn("LogsDatabaseV2")}
...
function wr(a,b,c,d,e){a={retry:!0,onSuccess:c,onError:d,hc:a,Ja:b,kr:!!e,headers:{},postBodyFormat:"",postBody:""};Ar()&&(a.headers["X-Goog-Request-Time"]=JSON.stringify(Math.round(Q())));return a}
...
":"+ma);if("IGNORED"===a.level)var ea=0;else a:{for(var Ee=Wr(),Fe=p(Ee.na),sd=Fe.next();!sd.done;sd=Fe.next()){var pa=sd.value;if(I.message&&I.message.match(pa.xr)){ea=pa.weight;break a}}for(var vp=p(Ee.ka),gk=vp.next();!gk.done;gk=vp.next()){var wp=gk.value;if(wp.callback(I)){ea=wp.weight;break a}}ea=1}I.sampleWeight=ea;for(var xp=p(Rr),hk=xp.next();!hk.done;hk=xp.next()){var ik=hk.value;if(ik.kb[I.name])for(var yp=p(ik.kb[I.name]),jk=yp.next();!jk.done;jk=yp.next()){var zp=jk.value,Sg=I.message.match(zp.regexp);
...
function ns(a){a=p(a.register.values());for(var b=a.next();!b.done;b=a.next())b.value.Br("ABORTED")}
...
return a.join("")}
;var rs=z.ytLoggingDocDocumentNonce_;rs||(rs=qs(),A("ytLoggingDocDocumentNonce_",rs));var ss=rs;var ts={Zh:0,te:1,Ee:2,Yl:3,bi:4,zq:5,Om:6,Do:7,Tn:8,ro:9,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE",8:"PUSH_NOTIFICATIONS",9:"RICH_GRID_WATCH"};function us(a){this.G=a}
...
lq:21667,mq:16749,nq:18635,oq:39305,pq:18046,qq:53969,rq:8213,sq:93926,tq:102852,uq:110099,wq:22678,xq:69076,yq:137575,Aq:139224,Bq:100856,Cq:154430,Dq:17736,Eq:3832,Fq:147111,Gq:55759,Hq:64031,Nq:93044,Oq:93045,Pq:34388,Qq:17657,Rq:17655,Sq:39579,Tq:39578,Uq:77448,Vq:8196,Wq:11357,Xq:69877,Yq:8197,Zq:156512,br:161613,dr:156509,er:161612,fr:161614,gr:82039};function Is(){var a=ub(Js),b;return(new Af(function(c,d){a.onSuccess=function(e){jl(e)?c(new Ks(e)):d(new Ls("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
function Mu(a,b,c){var d;if(b&&!(null==b?0:null==(d=b.Er)?0:d.Hr)&&a.j){d=p(Eu);for(var e=d.next();!e.done;e=d.next())e=e.value,a.j[e]&&a.j[e].handleResponse(b,c)}}
function Lu(a,b,c){var d,e,f,g,h,k,m,q,r,w,t,y,E,F,O,N,R,ca,U,rb,Va,na,I,ma,ea,Ee,Fe,sd;return x(function(pa){switch(pa.h){case 1:pa.u(2);break;case 3:if((d=pa.i)&&!d.isExpired())return pa.return(Promise.resolve(d.h()));case 2:if(null==(e=b)?0:null==(f=e.ga)?0:f.context)for(g=p([]),h=g.next();!h.done;h=g.next())k=h.value,k.Ar(b.ga.context);if(null==(m=a.i)||!m.Fr(b.input,b.ga)){pa.u(4);break}return v(pa,a.i.vr(b.input,b.ga),5);case 5:return q=pa.i,M("kevlar_process_local_innertube_responses_killswitch")||
...
case 6:U=pa.i;if(M("web_one_platform_error_handling")&&U&&"error"in U&&(null==(rb=U)?0:null==(Va=rb.error)?0:Va.details))for(na=U.error.details,I=p(na),ma=I.next();!ma.done;ma=I.next())ea=ma.value,(Ee=ea["@type"])&&-1<Fu.indexOf(Ee)&&(delete ea["@type"],U=ea);t&&a.h.has(t)&&a.h.delete(t);(null==(Fe=b.config)?0:Fe.kd)&&Z(b.config.kd);if(U||null==(sd=a.i)||!sd.lr(b.input,b.ga)){pa.u(7);break}return v(pa,a.i.ur(b.input,b.ga),8);case 8:U=pa.i;case 7:return Mu(a,U,b),pa.return(U||void 0)}})}
...
a.redirected||a.ok?this.h&&this.h.success():(this.h&&this.h.rr(),b=b.then(function(c){js(new P("Error: API fetch failed",a.status,a.url,c));return Object.assign({},c,{errorMetadata:{status:a.status}})}));
return b};
