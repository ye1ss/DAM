 ...
 * @author Alumno
 */
public class InsertarLineaResultSet {
     ...
     */
        public static void main(String[] args) {
            ...
            try{
                ...
                rs.updateRow();
                rs.afterLast();
                //Insertar un nuevo registro en el result set en la tabla
                rs.moveToInsertRow();
                rs.updateString("nombre", "Malena");
                rs.updateString("ciudad", "Vigo");
                rs.updateString("telefono", "688320911");
                rs.insertRow();
                rs.beforeFirst();
