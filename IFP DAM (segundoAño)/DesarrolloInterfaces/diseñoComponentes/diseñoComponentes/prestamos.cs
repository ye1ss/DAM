...
{
    /// <summary>
    /// inicializamos nombres, razas disponibles, cuotas, lugares y el diccionario
    /// </summary>
    public partial class ventanaPrestamos : Form
    {
        string nombre_cliente;
        string[] razas_disponibles = { "Barlog", "Drúedain", "Enano", "Elfo", "Ent", "Goblin", "Hobbit", "Hombre", "Istari (Mago)", "Orco", "Troll", "Uruk-hai" };
        ...
        /// <summary>
        /// hacemos el boton de cerrar
        /// y tmbien las validaciones
        /// </summary>
        ...
        /// <summary>
        /// confirmamos solicitudes
        /// y hacemos las validaciones
        /// <see cref="confirmarSolicitud"/>
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        private void razas_SelectedIndexChanged(object sender, EventArgs e)
        {
